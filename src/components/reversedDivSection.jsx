...
const ReversedDivSection = ({extras,edition,title,details,bgImage,btnText}) => {
  return (
    <div className={`flex justify-center ${extras} bg-cadburyPatternBg text-white bg-center bg-cover h-[87vh]`}>
        <div className={`w-[50%] flex justify-center items-center bg-boluColos ${extras}`}>
